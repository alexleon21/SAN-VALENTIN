...
function App() {
  ...
  {
    id: 1,
    description: "Piénsalo otra vez de nuevo.",
    img: "https://i.pinimg.com/originals/77/6b/21/776b215bed3deeef47fd3aa657685a18.gif"
  }
    ,
  {
    id: 2,
    description: "Vamos, atrévete yo se qui si.",
  ...
  {
    id: 4,
    description: "Confía en mí, nos divertiremos muchos.",
    img: "https://media.tenor.com/Bn88VELdNI8AAAAi/peach-goma.gif"
  },
  {
    id: 5,
    description: "No tengas dudas, te hará sonreír y sacarte muchas risa jsjs.",
